...
export const candidateFormFields = [
    { label: 'Código Alternativo Búsqueda', field: 'code', type: 'input', span: 12, required: false },
    { label: 'Fecha Apertura', field: 'opening_date', type: 'date', defaultValue: dayjs(), span: 12, required: true, readOnly: true },
    {
        label: 'Comercial', field: 'comerciales', type: 'api-select', span: 12, required: true,
        mode: 'multiple',
