...
// config parameters
// config parameters
const titleText = 'Evaluaciones Actitudinales'
const itemText = 'Evaluaciones Actitudinales'
const modelName = 'evaluaciones-actitudinales'
const modelNameSingle = 'evaluaciones-actitudinale'
