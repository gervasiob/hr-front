...
import CandidatePcp from './components/candidatePcp/index.vue'
import CandidateFeedback from './components/candidateFeedback/index.vue'
...
// config parameters
// config parameters
const titleText = 'Búsquedas del Candidato'
const itemText = 'Búsqueda Candidato'
const modelName = 'candidate-searchs'
const modelNameSingle = 'candidate-search'
